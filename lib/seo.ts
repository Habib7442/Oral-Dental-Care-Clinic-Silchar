...
export function getMetadata({
  ...
  const baseTitle = "Best Dentist in Silchar | Oral & Dental Care Clinic | Dr. Devarati Ray Dutta Chowdhury";
  const finalTitle = title ? `${title} | Oral & Dental Care Clinic` : baseTitle;
  
  const defaultDesc =
    "Oral & Dental Care Clinic is the best dental clinic in Silchar, led by Dr. Devarati Ray Dutta Chowdhury (BDS, MCh). 4.9★ rated. Specialized root canals, dental implants, crowns, and teeth alignment in Silchar, Assam.";
