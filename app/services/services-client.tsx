...
const getCardBgStyles = (category: Service["category"]) => {
  switch (category) {
    ...
    default:
      return "bg-white border-ink-300 hover:border-gold-500";
  }
};
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-8 relative z-10 w-full">
        ...
        <div className="flex flex-col items-start text-left max-w-3xl mb-12 md:mb-16">
          ...
          <p className="text-ink-700 text-sm sm:text-base leading-relaxed">
            Dr. Devarati Ray (BDS, MCh) offers 19 distinct advanced oral therapies. Filter by specialty area below to explore clinical roadmaps, recovery timelines, procedural highlights, and detailed FAQs.
          </p>
        </div>
          ...
          <AnimatePresence mode="popLayout">
            {filteredServices.map((service) => (
              <motion.div
                ...
                whileHover={{ y: -5 }}
                className={cn(
                  "group flex flex-col items-start border rounded-3xl p-6 md:p-8 transition-all duration-300 cursor-pointer relative",
